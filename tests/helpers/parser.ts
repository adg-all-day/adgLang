 ...
 *
 * Provides utilities for parsing ADGLANG source code in tests.
 */
...
/**
 * Parse ADGLANG source code into an AST Program
 *
 * @param source - ADGLANG source code
...
/**
 * Parse a single ADGLANG expression
 *
 * @param source - ADGLANG expression (without semicolon)
...
/**
 * Parse a single ADGLANG statement
 *
 * @param source - ADGLANG statement (with semicolon if needed)
