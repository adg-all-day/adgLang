...
const ADGLANG_COMPILER = path.join(process.cwd(), "adgLang");
...
describe("Operator Overloading Tests", () => {
  describe("Positive Tests - Should Compile and Run", () => {
    it("should handle basic arithmetic operators (+, -, *, /, %)", () => {
      const result = spawnSync(
        ADGLANG_COMPILER,
        ["examples/operator_overloading_arithmetic/main.adg"],
        { encoding: "utf-8" },
      );
    ...
    it("should handle bitwise operators (&, |, ^, ~, <<, >>)", () => {
      const result = spawnSync(
        ADGLANG_COMPILER,
        ["examples/operator_overloading_bitwise/main.adg"],
        { encoding: "utf-8" },
      );
    ...
    it("should handle unary operators (-, ~, +)", () => {
      const result = spawnSync(
        ADGLANG_COMPILER,
        ["examples/operator_overloading/main.adg"],
        { encoding: "utf-8" },
      );
  ...
  describe("Negative Tests - Should Fail Compilation", () => {
    it("should reject operator overload with wrong number of parameters", () => {
      const result = spawnSync(
        ADGLANG_COMPILER,
        ["examples/errors/operator_overloading_errors/wrong_params.adg"],
        { encoding: "utf-8" },
      );
    ...
    it("should reject operator overload with wrong return type for comparison", () => {
      const result = spawnSync(
        ADGLANG_COMPILER,
        ["examples/errors/operator_overloading_errors/wrong_return_type.adg"],
        { encoding: "utf-8" },
      );
    ...
    it("should reject use of operator without overload", () => {
      const result = spawnSync(
        ADGLANG_COMPILER,
        ["examples/errors/operator_overloading_errors/missing_operator.adg"],
        { encoding: "utf-8" },
      );
    ...
    it("should reject static operator overload", () => {
      const result = spawnSync(
        ADGLANG_COMPILER,
        ["examples/errors/operator_overloading_errors/static_operator.adg"],
        { encoding: "utf-8" },
      );
    ...
    it("should reject calling non-callable object", () => {
      const result = spawnSync(
        ADGLANG_COMPILER,
        ["examples/errors/operator_overloading_errors/not_callable.adg"],
        { encoding: "utf-8" },
      );
