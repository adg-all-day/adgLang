...
describe("GrammarParser", () => {
  it("should parse grammar.adg file correctly", () => {
    // Assuming the test runs from the project root or we can locate grammar.adg relative to this file
    // import.meta.dir is the directory of the test file (tests/)
    const grammarPath = join(import.meta.dir, "../grammar/grammar.adg");
