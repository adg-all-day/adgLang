...
function getClangVersion(): string {
  ...
  cachedClangVersion = "ADGLANG compiler";
  return cachedClangVersion;
}
...
export class DebugInfoGenerator {
  ...
  public getFileNodeId(filePath: string): number {
    ...
    // !1 = !DIFile(filename: "main.adg", directory: "/path/to/dir")
  ...
  public createCompileUnit(producer?: string): number {
    // !0 = distinct !DICompileUnit(language: DW_LANG_C99, file: !1, producer: "ADGLANG", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !2)
