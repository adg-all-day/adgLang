...
export abstract class AddressExpressionGenerator extends ReflectionGenerator {
  ...
  protected emitNullPointerCheck(
    ...
    if (this.optimizationLevel < 2) {
      ...
      this.emit(
        `  call void @__adgLang_check_null(i8* ${ptrAsI8}, i8* ${funcNamePtr}, i8* ${exprStrPtr}, i32 ${line}, i32 ${col})`,
      );
    }
  }
  ...
  protected emitBoundsCheck(
    ...
    this.emit(
      `  call void @__adgLang_throw_index_out_of_bounds(i32 ${idx32}, i32 ${size}, i8* ${funcNamePtr}, i32 ${line}, i32 ${col})`,
    );
