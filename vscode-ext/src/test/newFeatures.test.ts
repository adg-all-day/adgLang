...
describe("Selection Range Provider", () => {
  ...
  beforeAll(() => {
    ...
    testDoc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/test-selection.adg")}`,
      "adgLang",
      1,
      testContent,
    );
...
describe("Document Highlight Provider", () => {
  ...
  beforeAll(() => {
    ...
    testDoc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/test-highlight.adg")}`,
      "adgLang",
      1,
      testContent,
    );
...
describe("Folding Range Provider", () => {
  ...
  beforeAll(() => {
    ...
    const testContent = `import [App] from "adgLang-express";
...
struct Point {
    ...
    testDoc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/test-folding.adg")}`,
      "adgLang",
      1,
      testContent,
    );
  ...
  it("should fold imports region", () => {
    const testContentMultiImport = `import [App] from "adgLang-express";
import [Database] from "adgLang-db";
import [Array] from "std/array.adg";

frame main() {}`;

    const doc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/test-multi-import.adg")}`,
      "adgLang",
      1,
  ...
  it("should handle document with no foldable regions", () => {
    const simpleDoc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/simple.adg")}`,
      "adgLang",
      1,
      "local x: int = 5;",
    );
...
describe("Signature Help Provider", () => {
  ...
  it("should provide signature help for function calls", () => {
    ...
    const doc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/test-signature.adg")}`,
      "adgLang",
      1,
      testContent,
    );
  ...
  it("should handle signature help with multiple parameters", () => {
    ...
    const doc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/test-sig-multi.adg")}`,
      "adgLang",
      1,
      testContent,
    );
  ...
  it("should return null when not in a function call", () => {
    ...
    const doc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/test-no-sig.adg")}`,
      "adgLang",
      1,
      testContent,
    );
...
frame helper(x: int) ret int {
    ...
    const doc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/test-symbols.adg")}`,
      "adgLang",
      1,
      testContent,
    );
  ...
  it("should provide symbols for structs with fields and methods", () => {
    ...
    const doc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/test-struct-symbols.adg")}`,
      "adgLang",
      1,
      testContent,
    );
  ...
  it("should provide symbols for enums", () => {
    ...
    const doc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/test-enum-symbols.adg")}`,
      "adgLang",
      1,
      testContent,
    );
...
frame main() {}`;
    ...
    const doc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/test-globals.adg")}`,
      "adgLang",
      1,
      testContent,
    );
  ...
  it("should handle empty document", () => {
    const doc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/empty.adg")}`,
      "adgLang",
      1,
      "",
    );
...
frame main() {
    ...
    const doc = TextDocument.create(
      `file://${path.resolve(__dirname, "../../../tmp/integration-test.adg")}`,
      "adgLang",
      1,
      testContent,
    );
