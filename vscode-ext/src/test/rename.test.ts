...
describe("Rename Handler - Comprehensive Tests", () => {
  ...
  describe("Parameter Rename - Type Preservation", () => {
    ...
    return param + 1;
      ...
      const testFile = path.join(tmpDir, "param-simple.adg");
    ...
    return *ptr;
      ...
      const testFile = path.join(tmpDir, "param-pointer.adg");
    ...
    return x;
      ...
      const testFile = path.join(tmpDir, "param-const.adg");
    ...
    return value;
      ...
      const testFile = path.join(tmpDir, "param-from-body.adg");
  ...
  describe("Shadow Variables - Basic", () => {
    ...
    return x;
      ...
      const testFile = path.join(tmpDir, "shadow-basic.adg");
    ...
    return x;
      ...
      const testFile = path.join(tmpDir, "shadow-before.adg");
    ...
    return x;
      ...
      const testFile = path.join(tmpDir, "shadow-after.adg");
  ...
  describe("Deeply Nested Blocks - 10 Levels", () => {
    ...
    return x;
      ...
      const testFile = path.join(tmpDir, "nested-10-deep.adg");
    ...
    return val;
      ...
      const testFile = path.join(tmpDir, "nested-multiple-shadows.adg");
  ...
  describe("Complex Scoping Scenarios", () => {
    ...
    return x;
      ...
      const testFile = path.join(tmpDir, "sequential-blocks.adg");
    ...
    return i;
      ...
      const testFile = path.join(tmpDir, "loop-shadow.adg");
    ...
    return x;
      ...
      const testFile = path.join(tmpDir, "same-line.adg");
...
frame funcB(param: int) ret int {
    return param;
      ...
      const testFile = path.join(tmpDir, "multiple-functions.adg");
    ...
    return a + b + c;
      ...
      const testFile = path.join(tmpDir, "multiple-params.adg");
  ...
  describe("Edge Cases", () => {
    ...
    return x;
      ...
      const testFile = path.join(tmpDir, "nested-expressions.adg");
    ...
    loop (i < 10) {
      ...
      const testFile = path.join(tmpDir, "similar-names.adg");
  ...
  describe("Stress Test - Very Deep Nesting", () => {
    it("should handle extremely deep nesting (15 levels)", () => {
      ...
      const testFile = path.join(tmpDir, "stress-15-levels.adg");
  ...
  describe("Original Tests - Preserved", () => {
    ...
    loop (i < 10) {
      ...
      const testFile = path.join(tmpDir, "test-rename-i.adg");
    ...
    loop (i < 10) {
      ...
      const testFile = path.join(tmpDir, "test-rename-all-i.adg");
  ...
  describe("Shadow Variables in Loops - Edge Case", () => {
    ...
    return req;
      ...
      const testFile = path.join(tmpDir, "shadow-in-loop.adg");
  ...
  describe("Try-Catch Exception Variables", () => {
    ...
    try {
      ...
      const testFile = path.join(tmpDir, "catch-exception.adg");
    ...
    try {
      ...
      const testFile = path.join(tmpDir, "multiple-catch.adg");
  ...
  describe("Complex Control Flow", () => {
    ...
    switch (val) {
      ...
      const testFile = path.join(tmpDir, "switch-cases.adg");
    ...
    printf("%d", *resource);
      ...
      const testFile = path.join(tmpDir, "defer-block.adg");
    ...
    try {
      ...
      const testFile = path.join(tmpDir, "nested-catch.adg");
  ...
  describe("Multiple Shadows in Same Scope", () => {
    ...
    return x;
      ...
      const testFile = path.join(tmpDir, "multiple-shadows-same-level.adg");
  ...
  describe("Variables in Complex Expressions", () => {
    ...
    return arr[idx];
      ...
      const testFile = path.join(tmpDir, "array-operations.adg");
    ...
    return point.x + point.y;
      ...
      const testFile = path.join(tmpDir, "struct-member-access.adg");
...
frame test(value: int) ret int {
    return helper(value) + helper(value);
      ...
      const testFile = path.join(tmpDir, "function-calls.adg");
    ...
    return cast<float>(x);
      ...
      const testFile = path.join(tmpDir, "cast-expression.adg");
    ...
    return *ptr;
      ...
      const testFile = path.join(tmpDir, "unary-expression.adg");
    ...
    return a * b + c * a - b / a;
      ...
      const testFile = path.join(tmpDir, "binary-precedence.adg");
  ...
  describe("Loop Variables with Shadow", () => {
    ...
    return i;
      ...
      const testFile = path.join(tmpDir, "for-loop-iterator.adg");
    ...
    return count;
      ...
      const testFile = path.join(tmpDir, "while-loop-shadow.adg");
  ...
  describe("Edge Cases - Variable Name Patterns", () => {
    ...
    return _temp;
      ...
      const testFile = path.join(tmpDir, "underscore-prefix.adg");
    ...
    return myResult;
      ...
      const testFile = path.join(tmpDir, "camel-case.adg");
    ...
    return z;
      ...
      const testFile = path.join(tmpDir, "single-letter.adg");
    ...
    printf("%d", value);
      ...
      const testFile = path.join(tmpDir, "common-prefix.adg");
  ...
  describe("Pointer and Reference Operations", () => {
    ...
    *ptr = *ptr + 1;
    return ptr;
      ...
      const testFile = path.join(tmpDir, "pointer-operations.adg");
    ...
    return **ptrPtr;
      ...
      const testFile = path.join(tmpDir, "double-pointer.adg");
  ...
  describe("Conditional Expressions and Ternary", () => {
    ...
    return 0;
      ...
      const testFile = path.join(tmpDir, "if-conditions.adg");
    ...
    return (a || b) && (b || c) && a;
      ...
      const testFile = path.join(tmpDir, "boolean-expressions.adg");
  ...
  describe("Variables in Loop Conditions", () => {
    ...
    return sum;
      ...
      const testFile = path.join(tmpDir, "loop-condition-var.adg");
    ...
    return result;
      ...
      const testFile = path.join(tmpDir, "nested-loop-shared-var.adg");
  ...
  describe("Return Statement Variables", () => {
    ...
    return val * 2;
      ...
      const testFile = path.join(tmpDir, "early-return.adg");
    ...
    return x * 3;
      ...
      const testFile = path.join(tmpDir, "nested-return.adg");
  ...
  describe("Shadow Variables with Initialization from Shadowed", () => {
    ...
    return value;
      ...
      const testFile = path.join(tmpDir, "shadow-init-from-param.adg");
    ...
    return y;
      ...
      const testFile = path.join(tmpDir, "chained-shadow-init.adg");
  ...
  describe("Variables in Arithmetic Expressions", () => {
    ...
    return (a + 2) * (a - 1) / (a * 3);
      ...
      const testFile = path.join(tmpDir, "complex-arithmetic.adg");
    ...
    return (n % 10) & (n >> 2);
      ...
      const testFile = path.join(tmpDir, "bitwise-operations.adg");
  ...
  describe("Variables in Comparison Expressions", () => {
    ...
    return x > 0 && x < 100 && x != 50 && x == x;
      ...
      const testFile = path.join(tmpDir, "comparison-ops.adg");
