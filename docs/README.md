# adgLang Documentation

Welcome to the full documentation for **adgLang (Best Programming Language) v3**. This docs set walks through the language in detail, from core syntax to more advanced features.

## Quick Links

- 🚀 [Quick Start](03-quick-start.md) - Build your first adgLang program in 5 minutes
- 📚 [Language Reference](AGENTS.MD) - Compact language reference
...
- [Introduction](01-introduction.md) - What adgLang is and why you might want it
- [Installation](02-installation.md) - Get your development environment ready
- [Quick Start](03-quick-start.md) - Build your first adgLang program in 5 minutes

### Language Fundamentals

- [Syntax and Comments](04-syntax-comments.md) - Core syntax rules and comment styles
...
- [String Interpolation](54-string-interpolation.md) - Put expressions into strings with backticks
...
- [Structs](11-structs.md) - Create and use structures
...
- [Type Aliases](18-type-aliases.md) - Define custom type names with `type`
- [Function Pointers](19-function-pointers.md) - `Func<R>(P...)` and `Lambda<R>(P...)`
- [Type Matching](56-type-matching.md) - Runtime type checks with `match<Type>`, `is`, and `as`
...
- [Module Resolution](24-module-resolution.md) - How adgLang resolves modules
...
- [String Utilities](29-stdlib-string.md) - String handling with `String` struct
...
- [FFI (Foreign Function Interface)](36-ffi.md) - Call C functions with `extern`
- [LLVM Intrinsics](58-intrinsics.md) - Built-in functions for performance
- [Cross-Compilation](37-cross-compilation.md) - Build for different platforms
- [Code Formatting](38-code-formatting.md) - Keep code style consistent with `adgLang format`
...
Every page includes practical examples. If you want the full set of working programs, check the [examples directory](../examples/).

## Contributing

Found a mistake or want to make the docs better? Contributions are welcome. See [CONTRIBUTING.md](../CONTRIBUTING.md).

## License

This documentation uses the Apache-2.0 license, the same as the adgLang compiler.
