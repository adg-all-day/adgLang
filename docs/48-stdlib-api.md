...
Reference for the full adgLang standard library surface.

## Core Modules

### Math (`std/math.adg`)

Math functions and constants. See [Math Documentation](32-stdlib-math.md).

### Algorithm (`std/algorithm.adg`)

Algorithms for arrays, including sorting and searching. See [Algorithm Documentation](34-stdlib-algorithms.md).

### Array (`std/array.adg`)

Generic dynamic array implementation.

### String (`std/string.adg`)

Helpers for working with strings. See [String Documentation](29-stdlib-string.md).

### IO (`std/io.adg`)

Input and output utilities. See [IO Documentation](28-stdlib-io.md).

### FS (`std/fs.adg`)

File system utilities. See [FS Documentation](31-stdlib-fs.md).

### Time (`std/time.adg`)

Time and duration helpers. See [Time Documentation](33-stdlib-time.md).
...
Statistical helpers for numeric analysis.
...
### Rational (`std/rational.adg`)

Math for rational numbers (fractions).
...
### BitSet (`std/bitset.adg`)

Fixed-size bit array for efficient flags and set-style operations.
...
UUID generation and parsing for v4 random UUIDs.
...
### DateTime (`std/date.adg`)

Combined date and time type.
...
Pseudo-random number generator using an LCG.
