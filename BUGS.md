# adgLang Compiler Bug Report

This file keeps track of bugs and edge cases found during full testing.
...
| BUG-003 | Structs             | Recursive structs without pointers are currently allowed (infinite size).                                                           | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-004 | Functions           | Duplicate parameter names are currently allowed in function declarations.                                                           | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-005 | Arrays              | Zero-sized arrays are currently allowed (`Type[0]`).                                                                                | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-006 | Arrays              | Negative array sizes cause parser error instead of semantic error.                                                         | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-007 | Control Flow        | Duplicate cases in switch statements are currently allowed.                                                                         | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-008 | Scoping             | Variable shadowing in the same scope is currently allowed.                                                                          | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-009 | Control Flow        | Unreachable code after return is currently allowed.                                                                                 | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-010 | Analysis            | Unused variables are currently allowed without warning or error.                                                                    | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-011 | Type System         | Invalid type casts (e.g., `i32` to `string`) are currently allowed.                                                                 | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-012 | Structs             | Struct literals with missing fields are currently allowed (uninitialized memory).                                                   | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-013 | Control Flow        | Switch statements currently allow floating point values.                                                                            | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-014 | Analysis            | `sizeof<void>` is currently allowed.                                                                                                | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-015 | Arithmetic          | Modulo operator `%` is currently allowed for floating point types.                                                                  | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-016 | Arrays              | Array indexing with floating point values is currently allowed.                                                                     | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-017 | Operators           | Unary negation `-` is currently allowed for strings.                                                                                | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-018 | Operators           | String subtraction `"a" - "b"` is currently allowed.                                                                                | Fixed    |                                                                                                                                                                                                                                                                                          |
| BUG-019 | Assignment          | Assignment to r-values (literals, expressions) is currently allowed.                                                                | Fixed    |                                                                                                                                                                                                                                                                                          |
...
| BUG-030 | No Dynamic Dispatch | ADGLANG does not support dynamic dispatch (virtual methods). Method calls are statically resolved based on the pointer type.   | Fixed    |                                                                                                                                                                                                                                                                                          |
...
| BUG-038 | Semantics           | `void` variable declaration is currently allowed but unused.                                                                        | Fixed    | make it type checker error where no variable or argument can be "void" but allow "\*void" for pointers                                                                                                                                                                                   |
...
| BUG-046 | Arrays              | Multidimensional array syntax `T[N][M]` is currently allowed but size is incorrect (likely flattened or ignored).                   | Invalid  | Allow instantiation of multidimensional arrays without limit on number of dimensions                                                                                                                                                                                                     |
...
| BUG-056 | Enums               | Duplicate enum variants (e.g., `enum E { A, A }`) are currently allowed silently, creating ambiguity.                               | Fixed    |                                                                                                                                                                                                                                                                                          |
...
| BUG-062 | Operators           | Assignment chaining (e.g., `a = b = c`) is not supported. Assignment is a statement, not an expression.                    | Ignored  | By design - assignment is a statement, not an expression in ADGLANG.                                                                                                                                                                                                                         |
...
| BUG-066 | Parser              | The parser does not support empty tuples `()` in type declarations or expressions.                                         | Ignored  | By design - empty tuples are not supported in ADGLANG.                                                                                                                                                                                                                                       |
...
| BUG-071 | Parser              | ADGLANG function definitions (`frame`) do not support defining variadic functions.                                             | Fixed    | it does,sytnax is frame name (args:...type, count: int){}, this is minimal syntax, it support fixed args before variadic args, and count is implicit and passed by compiler                                                                                                              |
...
| BUG-117 | Generics            | Duplicate generic type parameters (e.g., `struct T<T, T>`) are silently allowed.                                          | Fixed    | TypeChecker now validates that all generic type parameter names are unique for functions, structs, and enums.                                                                                                                                                                            |
...
| BUG-122 | Enums               | Empty enum (`enum E {}`) is currently allowed but has no valid values or constructors.                                              | Fixed    | TypeChecker now validates that enums have at least one variant and throws a proper error for empty enums.                                                                                                                                                                                |
| BUG-123 | Specs               | Spec extending itself (`spec S : S`) is silently allowed.                                                                 | Fixed    | TypeChecker now detects self-extension in specs and throws a proper error.                                                                                                                                                                                                               |
...
| BUG-129 | Specs               | Duplicate method signatures in specs (`spec S { frame f(); frame f(); }`) are silently allowed.                           | Fixed    | Added duplicate method signature detection with Set-based tracking in TypeChecker.checkSpecBody().                                                                                                                                                                                       |
...
The compiler currently allows integer literals that don't fit in the target type.
...
Constant folding or type checking doesn't catch division by zero.
...
Structs can directly contain themselves, which leads to infinite size.
...
Functions currently allow multiple parameters with the same name.
...
Arrays with size 0 are currently allowed.
...
Switch statements currently allow duplicate case values.
...
Variables can be declared again in the same scope.
...
Code after a return statement is currently allowed and likely generated, which is wasteful and often a bug.
...
Variables that are declared but never used are currently allowed without warning.
...
The compiler currently allows casts between incompatible types, such as `i32` to `string`.
...
Switch statements currently allow floating point values, which is usually not supported or requires epsilon comparison.
...
The modulo operator `%` is currently allowed for floating point types.
...
Unary negation `-` is currently allowed for strings.
...
Subtraction operator `-` is currently allowed for strings.
...
The compiler currently allows assignment to r-values like literals or expressions.
...
The runtime does not do bounds checking on array access. Accessing `arr[100]` of a size 3 array returns garbage values instead of terminating the program.
...
The parser currently requires a trailing comma on the last field in a struct definition.
...
The parser does not support explicit type arguments in a struct literal.
...
Function calls don't support trailing commas, which makes multi-line arguments harder to maintain.
...
adgLang doesn't support dynamic dispatch (virtual methods). Method calls are statically resolved based on the pointer type.
...
**Testing**: Examples/enum_chaining_test/main.adg now compiles and runs successfully, correctly printing "Nested value: 40".
...
The compiler currently allows `local v: void;` but marks it as unused. Void variables should probably be disallowed entirely as they have no size or value.
...
Switch statements don't accept enum variants as case values, requiring raw literals instead. This defeats the purpose of using enums in switches.
...
**Category**: Pointers
**Status**: ✅ FIXED
**Description**: Casting an integer to a pointer (`cast<*int>(addr)`) creates a new temporary variable on the stack, stores the integer value in it, and returns the address of that temporary. It doesn't cast the integer value to a pointer type.
...
**Category**: Enums
**Description**: The parser doesn't support nested patterns in `match` expressions. It expects a simple variable binding or literal inside the variant constructor.
**Reproduction**:
...
**Description**: The parser enforces braces `{}` for `if` statements. It doesn't support single-statement bodies (e.g., `if (cond) stmt;`).
**Reproduction**:
...
**Category**: Control Flow
**Description**: The parser enforces braces `{}` for `switch` cases. It doesn't support single-statement cases.
**Reproduction**:
...
**Resolution**: The `adgLang.peggy` grammar has been updated to use a recursive rule for `MultiLineComment`, effectively supporting arbitrarily nested comments.

### BUG-062: Assignment Chaining Unsupported

**Category**: Operators
**Status**: Ignored (By Design)
**Description**: Assignment is treated as a statement, not an expression. Therefore, chaining assignments like `a = b = 10` is not supported. This is intentional - adgLang follows the design where assignment is a statement, not an expression.
**Reproduction**:
...
**Category**: FFI
**Description**: adgLang functions are implemented as fat pointers (closures) containing a function pointer and an environment pointer (size 16 bytes). This makes them incompatible with C functions that expect raw function pointers (size 8 bytes), and the compiler forbids casting them to `*void`.
**Reproduction**:
...
**Category**: Generics
**Description**: The compiler doesn't infer generic type arguments for constructors or static methods based on arguments. You need to explicitly specify the type parameters.
**Reproduction**:
...
**Category**: Parser
**Status**: Ignored (By Design)
**Description**: The parser doesn't support empty tuples `()` in type declarations or expressions. This is intentional - empty tuples are not supported in adgLang.
**Reproduction**:
...
**Category**: Parser
**Description**: The parser doesn't allow accessing tuple elements using dot notation with numbers (e.g., `tuple.0`).
**Reproduction**:
...
**Description**: Array types (fixed `T[N]` and dynamic `T[]`) don't expose a `.len` or `.length` property, making it impossible to query their size at runtime (for dynamic) or compile time (for fixed) via the type.
**Reproduction**:
...
**Description**: The parser doesn't support default values for function parameters. This is in the roadmap and will be implemented later.
**Reproduction**:
...
**Category**: Parser
**Status**: ✅ FIXED
**Description**: adgLang function definitions (`frame`) now support variadic functions. The syntax is `frame name(args: ...type, count: int){}`. It supports fixed args before variadic args, and count is implicit and passed by compiler.
**Reproduction**:
...
**Fix**: Added `typeAliasResolutionStack` to track types being resolved. When a type is found in the stack during resolution, a CompilerError is thrown with a clear message instead of infinite recursion.
**Implementation**:
 ...
 **Testing**: Examples/bug_072_recursive_type_alias/main.adg now properly errors with "Recursive type alias 'List' detected" instead of stack overflow
...
**Testing**: Examples/bug_087_function_equality/main.adg compiles and runs successfully with correct function pointer comparisons.
 ...
 **Testing**: Examples/bug_089_recursive_struct/main.adg now properly errors with "Struct 'Node' has infinite size due to recursive field types" instead of LLVM error
 ...
 **Testing**: Example/bug_073_struct_slicing/main.adg compiles and runs successfully, correctly calling the parent's method instead of the child's after slicing.
...
**Testing**: Examples/bug_074_string_switch/main.adg compiles and runs successfully.
...
**Description**: The parser doesn't support assigning explicit integer values to enum variants, which is necessary for C interoperability. Feature deferred - may be added in future version.
**Reproduction**:
 ...
 **Testing**: Test case created at Examples/bug_083_string_concat/main.adg but fix intentionally deferred.
...
**Category**: Parser
**Description**: The compiler doesn't support inline `export` declarations (e.g., `export frame foo...` or `export struct S...`). You need to declare the symbol first and then export it separately using `export symbol;` or `export [Type];`.
**Reproduction**:
...
**Testing**: Examples/enum_chaining_test/main.adg now compiles and runs successfully with nested qualified enum types like `std.Option<std.Option<int>>`.
...
**Testing**: Examples/enum_chaining_test/main.adg now correctly preserves nested enum values during assignment and pattern matching.
...
- `examples/hash_test/main.adg`: Updated `strEq` to use `*a == *b` for proper value equality
...
**Test File**: `examples/bug_hunt_session/test_self_inherit.adg`
...
**Test File**: `examples/bug_hunt_session/test_circular_inherit.adg`
...
**Test File**: `examples/bug_hunt_session/test_dup_generic_param.adg`
...
**Test File**: `tmp/unicode_test.adg`
...
**Test File**: `examples/bug_119_120_is_as/main.adg`
...
**Test File**: `examples/bug_hunt_session/test_sizeof.adg`
...
**Test File**: `examples/bug_hunt_session/test_empty_enum.adg`
...
**Test File**: `examples/bug_hunt_session/test_spec_self.adg`
...
**Description**: The unary plus operator (`+5`) is intentionally not supported in adgLang. It is a no-op in most languages and gives you no value.
