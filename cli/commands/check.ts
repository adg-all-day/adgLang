 ...
 *   adgLang check file1.adg file2.adg
 *   adgLang check main.adg -v
 *   adgLang check main.adg --json
 *   adgLang check main.adg --time
 */
export function registerCheckCommand(program: Command): void {
  program
    .command("check")
    .argument("<files...>", "ADGLANG files to type check")
    .description("Type check ADGLANG files without generating code (fast)")
