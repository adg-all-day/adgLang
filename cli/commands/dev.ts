 ...
 * `adgLang file.adg --watch --run` but optimized for development workflow.
 *
 * Examples:
 *   adgLang dev main.adg
 *   adgLang dev main.adg arg1 arg2
 *   adgLang dev main.adg --clear
 *   adgLang dev main.adg --no-run      # Compile only, don't execute
 *   adgLang dev main.adg -v --time
 */
export function registerDevCommand(program: Command): void {
  program
    .command("dev")
    .argument("<file>", "ADGLANG file to watch and run")
